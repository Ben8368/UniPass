...
- 每次门户 API 请求都会先从 [Chrome Web Store](https://chromewebstore.google.com/detail/unipass/gjphikebcceegfolnbfncepfmjnhdkam) 获取 UniPass 最新版本；访问或解析失败（5 秒超时）时安全回退到 `5.3.0`。`设置` 页可手动填写版本号，留空即可恢复自动获取。
